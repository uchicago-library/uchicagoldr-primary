...
from ..lib.readers.crazy_patch import CrazyReader
...
class Archiver(CLIApp):
    ...
    Uses the crazy reader, designed to port stages in a previous dev
    serialization forward into archives in the current format
    """
    @log_aware(log)
    def main(self):
        ...
        stage = CrazyReader(staging_env, args.stage_id).read()
